        ...
        <div class="container-fluid">
            <div class="row content-min-height">
                <div class="p-0 column-panel border-end" style="max-width: 230px; min-width: 230px; left: -230px;">
                    ...
                    @include('amicms.users._partial.navbar', ['mode'=>'add'])

                </div>
                <div class="col">
                    <div class="card-body">
                        <form action="{{ route('amicms::users.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="col-md">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-3">
                                                        <select class="form-select" name="account_type">
                                                            ...
                                                            <option value="1" selected>З правами доступу</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    ...
                                                    <td class="py-3">
                                                        <input name="first_name" type="text" placeholder="" class="form-control" value="{{ old('first_name') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-3">
                                                        <input name="email" type="text" placeholder="" class="form-control" value="{{ old('email') }}">
                                                        @if($errors->has('email'))
                                ...
                                <div class="tab-pane fade" id="v-pills-role" role="tabpanel" aria-labelledby="v-pills-role-tab">
                                    <div class="row">
                                        <div class="col">
                                            @include('amicms.users._partial.access-rights', ['mode'=>'add'])
                                        </div>
