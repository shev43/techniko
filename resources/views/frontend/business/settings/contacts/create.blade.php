    ...
    <main class="main page">
        ...
        <div class="container">
            ...
            <section class="seller_cabinet-settings-persons">
                <h2 class="title text-center">Додати контактну особу</h2>
                <div id="businessSettingContactsPhoto" class="row justify-content-center">
                    <div class="col-lg-3 col-md-4">
                        <div class="form-group text-center">
                            <img class="seller_cabinet-settings-logo" src="{{ asset('img/profile-logo.svg') }}" data-empty="{{ asset('img/profile-logo.svg') }}" alt="">
                        </div>
                    </div>
                ...
                <form id="businessSetting" action="{{ route('business::settings.contacts.store', ['lang'=>app()->getLocale()]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control js-name @error('name') is-invalid @enderror" id="name" placeholder="Вкажіть Ім'я контактної особи" value="{{ old('name') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input name="phone" type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" placeholder="Вкажіть телефон контактної особи" value=""{{ old('phone') }}>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <select class="selectpicker" name="position" data-title="Вкажіть посаду контактної особи" data-style="form-control @error('position') is-invalid @enderror">
                                    <option value="Водій" {{ old('position') == 'Водій' ? 'selected' : '' }}>Водій</option>
                                    <option value="Підтримка" {{ old('position') == 'Підтримка' ? 'selected' : '' }}>Підтримка</option>
                                    <option value="Диспетчер" {{ old('position') == 'Диспетчер' ? 'selected' : '' }}>Диспетчер</option>
                                    <option value="Менеджер" {{ old('position') == 'Менеджер' ? 'selected' : '' }}>Менеджер</option>
                                </select>
                            </div>
                        </div>
