            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                ...
                <tr>
                    <td style="text-align: left;padding-left:20px;padding-right:20px;padding-top:20px;padding-bottom:50px;" align="left">
                        ...
                        <h4 style="margin-top: 30px;margin-bottom: 40px;">Оцінка сервісу.</h4>

                        <p><strong>Ім'я:</strong> {{ $request['name'] }}</p>
                        <p><strong>ID користувача:</strong> {{ $request['personal_code'] }}</p>
                        <p><strong>Email:</strong> {{ $request['email'] ?? 'н/д' }}</p>
                        <p><strong>Телефон:</strong> {{ $request['phone'] ?? 'н/д' }}</p>
                        <p><strong>Що покращити?:</strong>
                            @foreach($request['question'] as $question)
                                <p>{{ $question }};</p>
                            @endforeach
                        </p>
                        <p><strong>Коментар:</strong> {{ $request['comment'] ?? 'н/д' }}</p>
